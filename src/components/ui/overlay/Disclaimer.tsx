  ...
  paragraphs: [
    {
      id: "welcome",
      content:
        "Welcome to Cineverse - a free and open-source movie streaming website. Please read this disclaimer carefully before using this website.",
    },
    {
      id: "purpose",
      content: "Cineverse is developed solely for",
    ...
    },
    {
      id: "content-source",
      content:
        "All content displayed on Cineverse (including but not limited to movies, images, posters, and related information) is sourced from",
    ...
    },
    {
      id: "responsibility",
      content:
        "By using Cineverse, you acknowledge that I bears no responsibility for user actions, content accuracy, or any direct or indirect damages arising from the use of this website. Users are solely responsible for their actions while using this service. I respect intellectual property rights and will respond to legitimate requests from copyright holders for content removal.",
    },
    {
      id: "usage",
      content:
        "This website should only be used for learning purposes. Any illegal activities, including but not limited to unauthorized downloading, redistribution of content, or commercial use, are strictly prohibited. By using Cineverse, you agree to these terms and acknowledge that",
